...
/**
 * Required to make Activity::attachBaseContext work.
 * More info about the bug/workaround: https://stackoverflow.com/a/58004553/1525990
 */
class BaseContextWrapperDelegate(private val superDelegate: AppCompatDelegate) : AppCompatDelegate(),
    OneMillionBot.SdkKoinComponent {
    ...
    private fun wrap(context: Context): Context = get<OneMillionBotContextWrapper> { parametersOf(context) }
}
