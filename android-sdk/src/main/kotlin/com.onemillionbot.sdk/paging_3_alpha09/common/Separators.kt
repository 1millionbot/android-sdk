...
import com.onemillionbot.sdk.paging_3_alpha09.common.LoadType.PREPEND
import com.onemillionbot.sdk.paging_3_alpha09.common.PageEvent.Insert
...
private class SeparatorState<R : Any, T : R>(
    ...
    fun <T : Any> Insert<T>.terminatesStart(): Boolean = if (loadType == LoadType.APPEND) {
    ...
    suspend fun onInsert(event: Insert<T>): Insert<R> {
        ...
        require(!footerAdded || event.loadType != LoadType.APPEND || eventEmpty) {
        ...
        if (!eventEmpty) {
            ...
            if (event.loadType == LoadType.APPEND && pageStash.isNotEmpty()) {
     ...
     */
    fun onDrop(event: PageEvent.Drop<T>) {
