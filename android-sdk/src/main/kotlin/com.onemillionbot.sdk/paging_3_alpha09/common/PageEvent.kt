    ...
    data class Insert<T : Any> private constructor(
        ...
        companion object {
            fun <T : Any> Refresh(
                ...
                combinedLoadStates: CombinedLoadStates
            ) = Insert(LoadType.REFRESH, pages, placeholdersBefore, placeholdersAfter, combinedLoadStates)

            fun <T : Any> Prepend(
                pages: List<TransformablePage<T>>,
                placeholdersBefore: Int,
                combinedLoadStates: CombinedLoadStates
            ) = Insert(LoadType.PREPEND, pages, placeholdersBefore, -1, combinedLoadStates)

            fun <T : Any> Append(
                pages: List<TransformablePage<T>>,
                placeholdersAfter: Int,
                combinedLoadStates: CombinedLoadStates
            ) = Insert(LoadType.APPEND, pages, -1, placeholdersAfter, combinedLoadStates)
